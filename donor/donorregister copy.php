    ...
    <div class="container">
        <div class="form-container">
          ...
          <?php if (!empty($message)): ?>
            ...
            <!-- <form id="donorRegisterForm" action="donorregister.php" method="POST" class="needs-validation" novalidate> -->
               <!-- Personal Details -->
                <div class="card mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="locallevel" name="locallevel" required>
                                ...
                                <?php
                                    ...
                                    $result = mysqli_query($conn, $query);
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        // Fetch latitude and longitude, ensuring they are properly formatted
                                        $latitude = $row['latitude'] !== NULL ? $row['latitude'] : '0.00000';
                                        $longitude = $row['longitude'] !== NULL ? $row['longitude'] : '0.00000';
                                        
                                        // Output the option with latitude and longitude
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="medical_conditions">Are you suffering from any medical conditions (if any)?</label>
                            <textarea class="form-control" id="medical_conditions" name="medical_conditions" rows="2" placeholder="No,Iam fit and fine or Yeah Iam suffering from this(blood,heart,cancer etc) disease"></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" id="personal_documents" name="personal_documents">
                                    <small class="form-text text-muted">Accepted formats: PDF, JPG, PNG. Only one file allowed.</small>
                                </div>
                                <div class="invalid-feedback">Please upload documents.</div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
<script src="assests/js/dregister.js"></script>
</body>
</html>