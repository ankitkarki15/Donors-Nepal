      ...
      <div class="row justify-content-center">
         <div class="col-md-8 col-lg-6">
            <div class="form-container">
               ...
               <!-- Success or Danger Alerts -->
               <div class="alert-container">
                  <!-- Success Alert (Uncomment if needed) -->
                  <!--
                  ...
                  <!-- Danger Alert (Uncomment if needed) -->
                  <!--
                  <div class="alert alert-danger">
                     <i class="fas fa-times-circle"></i> There was an error with your registration. Please try again.
                  </div>
                  -->
               </div>
