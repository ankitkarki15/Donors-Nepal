...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-white bg-white fixed-top">
        <!-- <a class="navbar-brand navbar-brand-logo" href="../home.php" style="color:blue">
            <span style="color:#cc0000"><b>DONORS</b> </span>Nepal</a> -->

            <a class="navbar-brand navbar-brand-logo" href="home.php" style="color: blue;"><strong>
    ...
    <span class="satisfy-regular">Nepal</span></strong>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <!-- <li class="nav-item">
                    <a class="nav-link" href="adminhome.php"><i class="fas fa-home"></i> Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="adminlogin.php"><i class="fas fa-plus"></i> Admin Login</a>
                </li> -->
