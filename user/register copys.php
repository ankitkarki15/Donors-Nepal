...
if (isset($_POST['register'])) {
    ...
    // Optional: Get latitude and longitude if provided
    ...
    if (count($errors) === 0) {
        ...
        if (mysqli_num_rows($select) > 0) {
            ...
            // Include latitude and longitude in your SQL query for insertion
            $sql = "INSERT INTO users (user_id, fullname, email, phone, password, latitude, longitude) 
                    VALUES ('$user_id', '$fullname', '$email', '$phone', '$hashedPassword', '$latitude', '$longitude')";
      ...
      document.addEventListener('DOMContentLoaded', function() {
         ...
         form.addEventListener('submit', async function(event) {
            ...
            try {
               ...
               // Manually trigger the form submission after updating the hidden fields
               form.submit();
            } catch (error) {
               alert(error);
            }
                  ...
                  navigator.geolocation.getCurrentPosition(resolve, error => {
                     ...
                     switch (error.code) {
                        case error.PERMISSION_DENIED:
                           message = 'Please enable location access to automatically capture your location.';
                           break;
