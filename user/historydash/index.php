            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="request" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="?page=donor_requests" class="sidebar-link">Donor Requests</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="?page=view_requests"  class="sidebar-link">View Blood Requests</a>
                        </li>
                    </ul>
                </li>
                
                <li class="sidebar-item">
                    <a href="?page=view_donors"class="sidebar-link">
