...
<head>
    ...
    <style>
        ...
        .document-img {
            max-width: 100%; /* Responsive */
            height: auto; /* Maintain aspect ratio */
            max-height: 600px; /* Increase height limit as needed */
        }
        .form-group {
            margin-bottom: 15px;
        }
            ...
            <table class="table table-bordered table-striped custom-table">
                ...
                <?php
                    if ($result->num_rows > 0) {
                                        ...
                                        <form method="POST" onsubmit="return confirmAction(\'' . $drid . '\', this.approval.value);">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="' . $personalDocPath . '" alt="Personal Document" class="img-fluid document-img"/>
                                                    <h6>Medical Document:</h6>
                                                    <img src="' . $medicalDocPath . '" alt="Medical Document" class="img-fluid document-img"/>
                                                </div>
                                            </div>
                        ...
                        echo '<tr><td colspan="8">No pending donor requests found.</td></tr>';
                    }
                ?>
                </tbody>
            </table>
